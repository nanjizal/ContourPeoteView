...
// webgl gl stuff
import cornerContourLimeTest.ShaderColor2D;
import cornerContourLimeTest.HelpGL;
import cornerContourLimeTest.BufferGL;

import lime.ui.Window;

// html stuff
#if js
import cornerContourLimeTest.DivertTrace;
#end
